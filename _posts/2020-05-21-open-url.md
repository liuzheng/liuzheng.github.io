...
注意：有关详细信息，请参见 http://msdn.microsoft.com/zh-cn/library/aa767914(VS.85).aspx。
...
有关如何在 Ubuntu 中为动作菜单项设置协议处理程序的详细信息，请参见 http://askubuntu.com/questions/527166/how-to-set-subl-protocol-handler-with-unity。
